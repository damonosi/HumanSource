...
const FormularAngajatoTransport = () => {
	const {
		register,
		handleSubmit,
		formState: { errors },
		...
		<form className="relative w-full justify-between  " onSubmit={handleSubmit(onSubmit)}>
			<div className="mb-4 grid grid-cols-1 gap-8 ">
				...
				<Input
					variant="outlined"
					type="text"
					{...register("numeFirma", { required: true })}
					id="nume"
					label="Numele firmei"
			...
			<div className="flex flex-col items-center justify-center gap-2 text-rosu-brand">
				{errors.numeFirma && <span>Trebuie sa adaugati numele firmei</span>}
...
export default FormularAngajatoTransport;
