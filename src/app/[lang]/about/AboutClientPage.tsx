		...
		<div className="container mt-[30px] flex w-full flex-col-reverse gap-6 pb-[100px] md:mt-14  lg:flex-row ">
			<div className="grid w-full  items-start gap-6 text-left lg:w-1/2" id="text-about">
				...
				<Typography variant="h5" className="max-w-[33rem] text-left font-bold leading-[30px] text-gri-brand ">
					Companie de resurse umane ce oferă servicii de atât pe partea de leasign de personal, recrutare, selecție cât
					și pe partea de payroll si administrare de personal.
				</Typography>
				<Typography variant="paragraph" className="text-left font-normal text-gri-brand  opacity-80 ">
					...
					amet pulvinar quis. Eu auctor ullamcorper imperdiet ultricies amet elementum quam. Tellus libero massa laoreet
					consequat porta id orci tempus. Dapibus quis curabitur vitae egestas sit feugiat tristique enim id. Enim lacus
					enim donec eget elementum. Mi imperdiet viverra tellus adipiscing amet vel risus. Nulla libero pulvinar nullam
					posuere blandit dignissim viverra eu magna. Blandit euismod risus vel leo.
				</Typography>
			</div>{" "}
